...
#ifndef PROJECTLP1_AED1_LIB_UTIL_H
#define PROJECTLP1_AED1_LIB_UTIL_H
...
int uniformArray(int *a, int N, int val_min,
                 int val_max); // function to fill an array with integer random uniformly distributed values (returns -1 if error)
int uniformDistinctArray(int *a, int N, int val_min,
                         int val_max); // function to fill an array with integer random uniformly distributed distinct values (returns -1 if error)
...
#endif //PROJECTLP1_AED1_LIB_UTIL_H
